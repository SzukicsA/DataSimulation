...
output$plot1 <- renderPlot({
  ...
  ggplot(res$data, aes(x, y)) +
    geom_hline(yintercept = 4, linetype = "dotted", linewidth  = 1) +
    geom_vline(xintercept = 4, linetype = "dotted", linewidth  = 1) +
    geom_hline(data = res$results |> drop_na(),
               aes(yintercept = meany), linetype = "solid", color = "purple", linewidth  = 1) +
    geom_vline(data = res$results |> drop_na(),
               aes(xintercept = meanx), linetype = "solid", color = "purple", linewidth  = 1) +
