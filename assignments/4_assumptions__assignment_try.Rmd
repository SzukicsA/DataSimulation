...
analyse_data <- function(data) {
  ...
  # Extract Cohen's d as the effect size
  control_mean <- mean(data[data$condition == "control", "score"])
  intervention_mean <- mean(data[data$condition == "intervention", "score"])
  pooled_sd <- sqrt((var(data[data$condition == "control", "score"]) + var(data[data$condition == "intervention", "score"])) / 2)
  cohen_d <- (control_mean - intervention_mean) / pooled_sd
